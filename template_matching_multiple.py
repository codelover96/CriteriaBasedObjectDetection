...
# For multiple occurrences, cv2.minMaxLoc() won’t give all the locations
...
img_rgb = cv2.imread('cropped_L1C_T34SGG_A026502_20200719T091703.tif')
img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)
template = cv2.imread('2_cropped_L1C_T34SGG_A026502_20200719T091703.tif', 0)
h, w = template.shape[::]
